...
void test_matmul_kernel_throughput(int m, int n, int k) {
    ...
    // auto activation_ptr = make_aligned_x86<float>(64, m * k);
    // auto weight_ptr = make_aligned_x86<float>(64, k * n);

    // auto activation_ptr = make_aligned_x86<int8_t>(64, m * k * sizeof(float));
    // auto weight_ptr = make_aligned_x86<int8_t>(64, k * n * sizeof(float));
