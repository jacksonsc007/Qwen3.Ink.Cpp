    ...
    const int M, const int N, const int K) 
{
    ...
    for (int j = 0; j < N; j += 4)
    {
        ...
        for (int p = 0; p < K; p += 2 * Q_BLK_SIZE)
        {
            ...
            int8_t zp_low_j0  = *zp_B ( block_idx    , j+0, K / Q_BLK_SIZE ); 
            int8_t zp_high_j0 = *zp_B ( block_idx + 1, j+0, K / Q_BLK_SIZE);
            b_pack_int8_low_j0 = _mm256_sub_epi8(b_pack_int8_low_j0, _mm256_set1_epi8(zp_low_j0));
            b_pack_int8_high_j0 = _mm256_sub_epi8(b_pack_int8_high_j0, _mm256_set1_epi8(zp_high_j0));
            
            // Process B for j+1
            int8_t zp_low_j1  = *zp_B ( block_idx    , j+1, K / Q_BLK_SIZE ); 
            int8_t zp_high_j1 = *zp_B ( block_idx + 1, j+1, K / Q_BLK_SIZE);
            ...
            b_pack_int8_low_j1 = _mm256_sub_epi8(b_pack_int8_low_j1, _mm256_set1_epi8(zp_low_j1));
            b_pack_int8_high_j1 = _mm256_sub_epi8(b_pack_int8_high_j1, _mm256_set1_epi8(zp_high_j1));
            
            // Process B for j+2
            int8_t zp_low_j2  = *zp_B ( block_idx    , j+2, K / Q_BLK_SIZE ); 
            int8_t zp_high_j2 = *zp_B ( block_idx + 1, j+2, K / Q_BLK_SIZE);
            ...
            b_pack_int8_low_j2 = _mm256_sub_epi8(b_pack_int8_low_j2, _mm256_set1_epi8(zp_low_j2));
            b_pack_int8_high_j2 = _mm256_sub_epi8(b_pack_int8_high_j2, _mm256_set1_epi8(zp_high_j2));
            
            // Process B for j+3
            int8_t zp_low_j3  = *zp_B ( block_idx    , j+3, K / Q_BLK_SIZE ); 
            int8_t zp_high_j3 = *zp_B ( block_idx + 1, j+3, K / Q_BLK_SIZE);
            ...
            b_pack_int8_low_j3 = _mm256_sub_epi8(b_pack_int8_low_j3, _mm256_set1_epi8(zp_low_j3));
            b_pack_int8_high_j3 = _mm256_sub_epi8(b_pack_int8_high_j3, _mm256_set1_epi8(zp_high_j3));
...
void MatmulOperator::qgemv_A80W4z_kernel(struct qwen_matmul_params *params) {
    ...
    matmul_kernel_gemv(
        ...
        params->A_scales, params->A_zero_point, params->scales,params->zero_point,
        m, n, k
    );
...
void MatmulOperator::qgemm_A80W4z_kernel(struct qwen_matmul_params *params) {
