...
void test_model_correctness()
{
    ...
    std::string param_path = "/root/workspace/tinyml/TinyChatEngine/qwen-7b-chat/transformer";
    Fp32QwenModel transformer(param_path, qwen_config);
    ...
    Fp32QwenModel_input input = Fp32QwenModel_input(input_ids);
    ...
    Fp32QwenModel_output output = transformer.forward(input);
    ...
    else
    {
        ...
        std::string output_path = 
            "/root/workspace/tinyml/TinyChatEngine/qwen-7b-chat/transformer/activation/input_embeds.bin";
        // output from cpp
        ...
        // output from python
        output_path = 
            "/root/workspace/tinyml/TinyChatEngine/qwen-7b-chat/transformer/activation/input_embeds_gt.bin";
