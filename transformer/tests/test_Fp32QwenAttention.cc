...
void test_model_pass()
{
    ...
    Fp32QwenAttention qwen_attention_layer(param_path, qwen_config);
    Fp32QwenAttention::initialize_memory(qwen_config);
    ...
    Fp32QwenAttention_input qwen_attention_input(hidden_states, attention_mask, 0);
    
    // evaluate
    Fp32QwenAttention_output qwen_attention_output = qwen_attention_layer.forward(qwen_attention_input);
